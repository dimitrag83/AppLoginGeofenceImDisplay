...
//        map.setOnMapClickListener(this);
    ...
    private static final double GEOFENCE_LAT = 55.911;
    private static final double GEOFENCE_LON = -3.278;
    ...
    private void startGeofence(){
        ...
        com.google.android.gms.location.Geofence geofence = createGeofence( new LatLng(GEOFENCE_LAT, GEOFENCE_LON), GEOFENCE_RADIUS );
    ...
    public static Intent makeNotificationIntent(Context applicationContext, String msg) {
        Log.d(TAG,msg);
        return new Intent(applicationContext,Geofence.class);
